"""
  ...
  Team members:  Jonathan Moyers, Grant Duchars, Liam Enneking.
  Fall term, 2018-2019.
"""
...
class InfraredAsProximitySensor(low_level_rb.InfraredSensor):
    ...
    Primary authors:  The ev3dev authors, David Mutchler, Dave Fisher,
       their colleagues, the entire team, and Liam Enneking.
    """
    # DONE: In the above line, put the name of the primary author of this class.
    ...
    def get_distance_to_nearest_object_in_inches(self):
        ...
        return (70 / inches_per_cm) * (float(self.get_distance_to_nearest_object()) / 100)
...
class ArmAndClaw(object):
    ...
    def move_arm_to_position(self, position):
        ...
        touches = 0
        while True:
            # If the arm hits the touch sensor it starts to go back down
            if self.touch_sensor.get_value() == 1:
                self.motor.start_spinning(-100)
                touches += 1
                time.sleep(1)
